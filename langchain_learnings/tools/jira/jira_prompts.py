...
JIRA_ISSUE_CREATE_PROMPT = """
    ...
    For example, to create a low priority task for called "test issue" with description "test description" for project KEY, you would pass in the following dictionary: 
    {{"summary": "test issue", "description": "test description", "project": {{ "key": "KEY" }}, "issuetype": {{"name": "Task"}}, "priority": {{"name": "Low"}}}}
    """
